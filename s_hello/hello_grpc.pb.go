...
type AuthenticatorClient interface {
	Auth(ctx context.Context, in *TryAuthRequest, opts ...grpc.CallOption) (*Authenticated, error)
}
...
func (c *authenticatorClient) Auth(ctx context.Context, in *TryAuthRequest, opts ...grpc.CallOption) (*Authenticated, error) {
	out := new(Authenticated)
	err := c.cc.Invoke(ctx, "/main.Authenticator/Auth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticatorServer interface {
	Auth(context.Context, *TryAuthRequest) (*Authenticated, error)
...
func (UnimplementedAuthenticatorServer) Auth(context.Context, *TryAuthRequest) (*Authenticated, error) {
...
func _Authenticator_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TryAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthenticatorServer).Auth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.Authenticator/Auth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticatorServer).Auth(ctx, req.(*TryAuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Authenticator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Auth",
			Handler:    _Authenticator_Auth_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "s_hello/hello.proto",
